...
export default function SignUp() {
    ...
    useEffect(() =>{
        if(!email.toLowerCase().endsWith("@usc.edu") && email.length != 0 && email.includes("@"))
        {
    ...
    return(
        <>
        <div id="SignUp">
            <h3 id="register" className="SUtext"> Register for an Account </h3>
        ...
        <Box
            ...
            autoComplete="off"
        >
         <TextField id="outlined-basic" name="password_repeat" label="Username" variant="outlined" value={username} onChange={(e) => setUsername(e.target.value)} required /> 
        </Box>
